...
required_paths=(
    ...
    "packages/tui/native/linux/src/linux-platform-wayland.c"
    "packages/tui/native/linux/src/linux-platform-x11.c"
    "packages/tui/native/linux/protocol/ext-data-control-v1.xml"
    "packages/tui/native/linux/protocol/wlr-data-control-unstable-v1.xml"
    "packages/tui/native/linux/prebuilds/linux-arm64/linux-platform-wayland.node"
    "packages/tui/native/linux/prebuilds/linux-arm64/linux-platform-x11.node"
    "packages/tui/native/linux/prebuilds/linux-x64/linux-platform-wayland.node"
